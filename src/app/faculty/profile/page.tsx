...
>
  <div className="absolute inset-0 bg-black bg-opacity-60 flex items-center p-8">
    <div className="flex items-center space-x-6">
      ...
      <div>
        ...
        {/* Faculty Post */}
        <p className="text-xl text-gray-300">{facultyProfile.post}</p>
      </div>
    </div>
    ...
    <div className="ml-auto flex space-x-4">
      <button
        onClick={goBack}
        className="px-5 py-3 bg-gray-800 rounded-lg text-white hover:bg-gray-700 transition duration-300 shadow-lg"
      >
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
          ...
          <p className="flex items-center text-lg text-gray-300 mb-4">
          ...
          <div>
            <h3 className="text-lg text-blue-400 font-bold mb-2">Interests:</h3>
        ...
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
          ...
          <p className="flex items-center text-lg text-gray-300 mb-4">
            <School className="w-5 h-5 mr-3 text-blue-400" />
