...
const UpcomingEventsSection: React.FC<UpcomingEventsSectionProps> = ({
  ...
  return (
    <div className="mt-16 bg-gradient-to-br from-gray-100 to-gray-200 text-gray-900 p-12 rounded-lg shadow-2xl">
      ...
      <div className="flex justify-center space-x-6 mt-8">
        <button
          ...
          className="group px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-500 text-gray-900 font-medium rounded-full shadow-lg hover:shadow-gray-600/50 transition duration-300 transform hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
        >
