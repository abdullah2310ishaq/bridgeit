...
var FacultyDropDown_1 = require("./FacultyDropDown");
var FacultyNavBar = function (_a) {
        ...
        react_1["default"].createElement("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" },
            react_1["default"].createElement("div", { className: "flex justify-between h-16" },
                react_1["default"].createElement("div", { className: "flex items-center" },
                    react_1["default"].createElement(link_1["default"], { href: "/faculty", className: "text-green-500 text-2xl font-bold hover:text-green-400" }, "Faculty Module")),
                ...
                react_1["default"].createElement(react_1["default"].Fragment, null,
                    react_1["default"].createElement("button", { className: "px-3 py-2 text-sm font-medium transition duration-300 " + (isActiveLink(link)
                            ...
                            : "text-gray-300 hover:text-green-500") }, link.name),
                    react_1["default"].createElement("div", { className: "absolute left-0 mt-2 w-48 bg-gray-800 shadow-lg rounded-md opacity-0 group-hover:opacity-100 transition-opacity duration-200 z-50" }, link.children.map(function (child) { return (react_1["default"].createElement(link_1["default"], { key: child.name, href: child.href, className: "block px-4 py-2 text-sm hover:bg-gray-700 " + (activePage.startsWith(child.href)
                            ...
                            : "text-gray-300 hover:text-green-500") }, child.name)); })))) : (
                // Render normal link
                react_1["default"].createElement(link_1["default"], { href: link.href, className: "relative px-3 py-2 text-sm font-medium transition duration-300 " + (isActiveLink(link)
                    ...
                    link.name,
                    isActiveLink(link) && (react_1["default"].createElement("span", { className: "absolute left-0 bottom-0 w-full h-0.5 bg-green-500 animate-slideIn" })))))); })),
                react_1["default"].createElement("div", { className: "hidden md:flex items-center" },
                    react_1["default"].createElement(FacultyDropDown_1["default"], { userProfile: userProfile, onLogoutClick: handleLogoutClick })),
                react_1["default"].createElement("div", { className: "md:hidden flex items-center" },
                    react_1["default"].createElement("button", { onClick: function () { return setMobileMenuOpen(!mobileMenuOpen); }, className: "text-gray-300 hover:text-green-500 focus:outline-none" },
                ...
                react_1["default"].createElement("div", { className: "px-2 pt-2 pb-3 space-y-1 sm:px-3" },
                    ...
                    react_1["default"].createElement("div", { className: "space-y-1" },
                        react_1["default"].createElement("button", { 
                            ...
                            className: "block w-full text-left px-3 py-2 rounded-md text-base font-medium transition duration-300 " + (isActiveLink(link)
                                ? "text-green-500 bg-gray-700"
                                : "text-gray-300 hover:text-green-500") }, link.name),
                    ...
                    react_1["default"].createElement("button", { onClick: function () {
                        ...
                        }, className: "block w-full text-left px-3 py-2 text-gray-300 hover:text-green-500 rounded-md text-base font-medium transition duration-300" }, "View Profile"),
                    react_1["default"].createElement("button", { onClick: function () {
                            router.push("/faculty/profile/editfaculty");
                            setMobileMenuOpen(false);
                        }, className: "block w-full text-left px-3 py-2 text-gray-300 hover:text-green-500 rounded-md text-base font-medium transition duration-300" }, "Edit Profile"),
                    react_1["default"].createElement("button", { onClick: function () {
                            setMobileMenuOpen(false);
                            handleLogoutClick();
