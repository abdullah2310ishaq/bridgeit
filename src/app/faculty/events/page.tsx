    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-gray-100 p-6">
      ...
      <div className="flex justify-center mb-8">
        <button
          ...
          className="flex items-center px-6 py-2 bg-gray-700 hover:bg-gray-800 text-white font-medium rounded-full shadow-lg transition-all duration-300"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {filteredEvents.length > 0 ? (
          filteredEvents.map((event, index) => (
            <div
              key={event.id}
              className="relative p-6 rounded-xl shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 overflow-hidden bg-gradient-to-br from-gray-800 to-gray-700"
            >
