...
const CreateEventPage: React.FC = () => {
  ...
  const handleCreateEvent = async () => {
    ...
    try {
      const response = await fetch('http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/Events/add-event', {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${token}`,
