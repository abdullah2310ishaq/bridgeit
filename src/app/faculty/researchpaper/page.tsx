    ...
    async function fetchFacultyAndResearchPapers() {
      ...
      try {
        ...
        if (userResponse.ok) {
          ...
          const facultyResponse = await fetch(`http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/get-faculty/faculty-by-id/${userId}`, {
            method: "GET",
            headers: {
              Authorization: `Bearer ${token}`,
            },
          ...
          if (facultyResponse.ok) {
            ...
            const researchResponse = await fetch(`http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/ResearchWork/get-researchwork-by-id/${facultyId}`, {
              method: "GET",
              headers: {
                Authorization: `Bearer ${token}`,
              },
