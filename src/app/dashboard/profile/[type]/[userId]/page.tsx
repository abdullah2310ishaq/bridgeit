...
async function fetchProfile(type: string, userId: string): Promise<UserProfile | null> {
  try {
    ...
    switch (type) {
      case 'student':
        url = `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/get-student/student-by-id/${userId}`;
        break;
      case 'faculty':
        url = `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/get-faculty/faculty-by-id/${userId}`;
        break;
      case 'industry':
        url = `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/get-industry-expert/industry-expert-by-id/${userId}`;
        break;
      default:
