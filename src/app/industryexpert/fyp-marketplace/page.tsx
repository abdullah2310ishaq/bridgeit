...
export default function FYPMarketplacePage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const facultiesResponse = await fetch("http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/get-faculty/faculties", {
          headers: { Authorization: `Bearer ${token}` },
        })
        ...
        for (const faculty of facultiesData) {
          try {
            const fypResponse = await fetch(`http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/fyp/get-fyp-by-faculty-id/${faculty.id}`, {
              headers: { Authorization: `Bearer ${token}` },
            })
        ...
        try {
          ...
          const buyFypsResponse = await fetch("http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/fyp/for-marketplace/buy", {
            headers: { Authorization: `Bearer ${token}` },
          })

          // Try to fetch "Sponsor" FYPs (ongoing projects)
          const sponsorFypsResponse = await fetch("http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/fyp/for-marketplace/sponsor", {
            headers: { Authorization: `Bearer ${token}` },
          })
  ...
  const submitFypRequest = async () => {
    ...
    try {
      const response = await fetch(`http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/ind-expert-request-fyp/add/${selectedFyp.id}`, {
        method: "POST",
        headers: {
