    ...
    const fetchFypDetails = async () => {
      ...
      try {
        ...
        const fypResponse = await fetch(
          `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/fyp/get-detailed-fyp-by-id/${fypId}`,
          {
            headers: { Authorization: `Bearer ${token}` },
          },
        )
        ...
        try {
          const requestResponse = await fetch(
            `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/ind-expert-request-fyp/check-status?fypId=${fypId}&expertId=${expertData.indExptId}`,
            {
              headers: { Authorization: `Bearer ${token}` },
            },
          )
  ...
  const handleRequestFyp = async () => {
    ...
    try {
      const response = await fetch(
        `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/ind-expert-request-fyp/add/${fypId}`,
        {
          method: "POST",
          headers: {
