...
const IndustryExpertProfileManagement: React.FC = () => {
  ...
  const handlePasswordChange = async (e: React.FormEvent) => {
    ...
    try {
      const confirmResponse = await fetch(`https://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/edit-user-profile/confirm-current-password/${userId}`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
