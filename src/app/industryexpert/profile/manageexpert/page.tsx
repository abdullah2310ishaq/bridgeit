...
const IndustryExpertProfileManagement: React.FC = () => {
  ...
  const handlePasswordChange = async (e: React.FormEvent) => {
    ...
    try {
      const confirmResponse = await fetch(`http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/edit-user-profile/confirm-current-password/${userId}`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
