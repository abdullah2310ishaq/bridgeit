    ...
    try {
      ...
      if (projectData.status !== "Completed") {
        ...
        const completeRes = await fetch(
          `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/projects/${projectId}/complete`,
          {
            method: "PATCH",
            headers: {
    ...
    const fetchPaymentDetails = async () => {
      ...
      try {
        ...
        const res = await fetch(
          `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/payment-details/payment-details/${projectId}`,
          {
            headers: { Authorization: `Bearer ${token}` },
          },
        )
