    ...
    const fetchMeetingDetails = async () => {
      ...
      try {
        ...
        const meetingResponse = await fetch(
          `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/fyp-meeting/by-id/${meetingId}`,
          {
        ...
        try {
          const sponsoredResponse = await fetch(
            `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/fyp-meeting/is-sponsored/${meetingDetails.fypId}`,
            {
              headers: { Authorization: `Bearer ${token}` },
            },
          )
  ...
  const handleCompleteMeeting = async () => {
    ...
    try {
      const response = await fetch(
        `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/fyp-meeting/after-meeting/${meetingId}`,
        {
          method: "PATCH",
          headers: {
