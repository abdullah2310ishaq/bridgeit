    ...
    const fetchMeetings = async () => {
      ...
      try {
        ...
        const meetingsResponse = await fetch(
          `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/fyp-meeting/by-id/${industryExpertId}`,
          {
            headers: { Authorization: `Bearer ${token}` },
          },
        )
