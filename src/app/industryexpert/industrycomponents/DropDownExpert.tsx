  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef}>
      ...
      >
        ...
        />
        <FaChevronDown className="ml-2 text-gray-300 hover:text-blue-500 transition duration-300" />
      </button>
      {dropdownOpen && (
        <div className="origin-top-right absolute right-0 mt-2 w-64 rounded-md shadow-lg bg-gray-800 ring-1 ring-black ring-opacity-5 z-50">
          <div className="py-1" role="menu" aria-orientation="vertical">
            ...
            <button
              ...
              className="flex items-center w-full text-left px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-blue-500 transition duration-300"
            >
