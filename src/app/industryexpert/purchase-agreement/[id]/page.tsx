      ...
      try {
        ...
        try {
          const boughtFypResponse = await fetch(
            `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/bought-fyp/by-id/${fypId}`,
            {
              headers: { Authorization: `Bearer ${token}` },
            },
          )
  ...
  const createBoughtFypRecord = async (token: string): Promise<string> => {
    ...
    try {
      const response = await fetch(
        `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/bought-fyp/create`,
        {
          method: "POST",
          headers: {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const agreementResponse = await fetch(
        `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/bought-fyp/add-agreement/${recordId}`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
      ...
      const checkoutResponse = await fetch(
        `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/payments/create-checkout-session/fyp/${fyp.id}`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
