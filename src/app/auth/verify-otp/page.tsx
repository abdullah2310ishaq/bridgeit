          ...
          <div className="flex justify-center gap-2 mb-6">
            {otp.map((digit, index) => (
              <input
                ...
                className="w-12 h-12 text-center text-xl bg-gray-900 text-gray-100 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
              />
            ))}
          </div>
