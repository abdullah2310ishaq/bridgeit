...
var NavBar = function (_a) {
    ...
    return (react_1["default"].createElement("nav", { className: "bg-white fixed w-full top-0 z-50 shadow-md" },
        react_1["default"].createElement("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" },
            react_1["default"].createElement("div", { className: "flex justify-between h-16" },
                react_1["default"].createElement("div", { className: "flex items-center" },
                    react_1["default"].createElement(link_1["default"], { href: "/student", className: "text-blue-600 text-2xl font-bold hover:text-blue-800" }, "BridgeIT")),
                ...
                react_1["default"].createElement(react_1["default"].Fragment, null,
                    react_1["default"].createElement("button", { className: "px-3 py-2 text-sm font-medium transition duration-300 " + (isActiveLink(link)
                            ...
                            : "text-gray-600 hover:text-blue-600") }, link.name),
                    react_1["default"].createElement("div", { className: "absolute left-0 mt-2 w-48 bg-white shadow-lg rounded-md opacity-0 group-hover:opacity-100 transition-opacity duration-200 z-50" }, link.children.map(function (child) { return (react_1["default"].createElement(link_1["default"], { key: child.name, href: child.href, className: "block px-4 py-2 text-sm hover:bg-gray-100 " + (activePage.startsWith(child.href)
                            ? "text-blue-600 bg-gray-100"
                            : "text-gray-600 hover:text-blue-600") }, child.name)); })))) : (
                // Render normal link
        ...
        react_1["default"].createElement(react_2.Transition, { show: mobileMenuOpen, enter: "transition ease-out duration-200 transform", enterFrom: "opacity-0 -translate-y-2", enterTo: "opacity-100 translate-y-0", leave: "transition ease-in duration-150 transform", leaveFrom: "opacity-100 translate-y-0", leaveTo: "opacity-0 -translate-y-2" },
            react_1["default"].createElement("div", { className: "md:hidden bg-white shadow-md" },
                react_1["default"].createElement("div", { className: "px-2 pt-2 pb-3 space-y-1 sm:px-3" },
                    ...
                    react_1["default"].createElement("div", { className: "space-y-1" },
                        react_1["default"].createElement("button", { onClick: function () { return setMobileMenuOpen(function (prev) { return !prev; }); }, className: "block w-full text-left px-3 py-2 rounded-md text-base font-medium transition duration-300 " + (isActiveLink(link)
                                ? "text-blue-600 bg-gray-100"
                                : "text-gray-600 hover:text-blue-600") }, link.name),
                    ...
                    react_1["default"].createElement("button", { onClick: function () {
                        ...
                        }, className: "block w-full text-left px-3 py-2 text-gray-600 hover:text-blue-600 rounded-md text-base font-medium transition duration-300" }, "View Profile"),
                    react_1["default"].createElement("button", { onClick: function () {
                            router.push("/student/profile/edit");
                            setMobileMenuOpen(false);
                        }, className: "block w-full text-left px-3 py-2 text-gray-600 hover:text-blue-600 rounded-md text-base font-medium transition duration-300" }, "Edit Profile"),
                    react_1["default"].createElement("button", { onClick: function () {
                            setMobileMenuOpen(false);
                            handleLogoutClick();
                        }, className: "block w-full text-left px-3 py-2 text-red-600 hover:text-red-800 rounded-md text-base font-medium transition duration-300" }, "Logout")))),
        react_1["default"].createElement(react_2.Transition, { appear: true, show: isLogoutDialogOpen, as: react_1["default"].Fragment },
            react_1["default"].createElement(react_2.Dialog, { as: "div", className: "relative z-50", onClose: handleCancelLogout },
                react_1["default"].createElement(react_2.Transition.Child, { as: react_1["default"].Fragment, enter: "ease-out duration-300", enterFrom: "opacity-0", enterTo: "opacity-100", leave: "ease-in duration-200", leaveFrom: "opacity-100", leaveTo: "opacity-0" },
                    react_1["default"].createElement("div", { className: "fixed inset-0 bg-gray-900 bg-opacity-50" })),
                react_1["default"].createElement("div", { className: "fixed inset-0 overflow-y-auto" },
                    react_1["default"].createElement("div", { className: "flex items-center justify-center min-h-full p-4 text-center" },
                        react_1["default"].createElement(react_2.Transition.Child, { as: react_1["default"].Fragment, enter: "ease-out duration-300", enterFrom: "opacity-0 scale-95", enterTo: "opacity-100 scale-100", leave: "ease-in duration-200", leaveFrom: "opacity-100 scale-100", leaveTo: "opacity-0 scale-95" },
                            react_1["default"].createElement(react_2.Dialog.Panel, { className: "max-w-md w-full bg-white rounded-lg p-6 shadow-lg transform transition-all" },
                                react_1["default"].createElement("div", { className: "flex items-center space-x-4" },
                                    ...
                                    react_1["default"].createElement(react_2.Dialog.Title, { className: "text-xl font-semibold text-gray-900" }, "Confirm Logout")),
                                react_1["default"].createElement("div", { className: "mt-4" },
                                    react_1["default"].createElement("p", { className: "text-sm text-gray-500" }, "Are you sure you want to log out? You will need to log back in to access your account.")),
                                react_1["default"].createElement("div", { className: "mt-6 flex justify-end space-x-4" },
                                    react_1["default"].createElement("button", { onClick: handleCancelLogout, className: "px-4 py-2 text-sm font-medium text-gray-600 bg-gray-100 hover:bg-gray-200 rounded-md transition" }, "Cancel"),
