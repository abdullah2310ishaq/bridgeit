    ...
    return (react_1["default"].createElement("div", { className: "fixed inset-0 bg-black bg-opacity-60 backdrop-blur-sm flex items-center justify-center z-50" },
        react_1["default"].createElement("div", { className: "bg-gradient-to-b from-gray-900 to-gray-800 text-gray-300 p-8 rounded-lg shadow-xl w-full max-w-lg relative" },
            ...
            react_1["default"].createElement("div", { className: "mt-6 flex justify-end space-x-4" },
                react_1["default"].createElement("button", { className: "px-6 py-2 rounded-lg font-semibold text-white shadow-lg transition-all duration-200 " + (isSubmitting
                        ? "bg-gray-500 cursor-not-allowed"
                        : "bg-green-600 hover:bg-green-500"), onClick: handleSubmitProposal, disabled: isSubmitting }, isSubmitting ? "Submitting..." : "Submit Proposal"),
                react_1["default"].createElement("button", { className: "px-6 py-2 rounded-lg bg-red-600 text-white font-semibold hover:bg-red-500 shadow-lg transition-all duration-200", onClick: onClose }, "Cancel"))),
