...
const ProposalModal: React.FC<ProposalModalProps> = ({
  ...
  const handleSubmitProposal = async () => {
    ...
    try {
      ...
      const resp = await fetch("http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/project-proposals/send-proposal", {
        method: "POST",
