...
var ProfilePage = function () {
    ...
    return (react_1["default"].createElement("div", { className: "relative min-h-screen flex flex-col items-center justify-center bg-gray-900 p-6 overflow-hidden" },
        ...
        react_1["default"].createElement(framer_motion_1.motion.div, { initial: { opacity: 0, x: -80 }, animate: { opacity: 1, x: -80 }, transition: { duration: 0.5 }, className: "relative z-10 bg-gray-800/60 backdrop-blur-sm p-8 rounded-xl shadow-lg w-full max-w-md h-auto lg:max-w-lg" // Adjusted max width for a more vertical layout
         },
