...
var image_1 = require("next/image"); // For logo and images
        ...
        react_1["default"].createElement("div", { className: "w-full lg:max-w-xl p-6 rounded-lg shadow-lg bg-gray-800" },
            ...
            react_1["default"].createElement("form", { onSubmit: handlePasswordChange, className: "space-y-6" },
                ...
                react_1["default"].createElement("div", { className: "flex justify-center" },
                    react_1["default"].createElement("button", { type: "submit", className: "w-full py-4 px-6 bg-gradient-to-r from-purple-500 to-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-gradient-to-r hover:from-purple-600 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200" }, "Change Password"))),
            react_1["default"].createElement("form", { onSubmit: handleImageUpload, className: "mt-8 space-y-6" },
                ...
                react_1["default"].createElement("div", { className: "flex justify-center" },
                    react_1["default"].createElement("button", { type: "submit", className: "w-full py-4 px-6 bg-gradient-to-r from-green-500 to-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-gradient-to-r hover:from-green-600 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-green-500 transition duration-200" }, "Upload Image")))),
        react_1["default"].createElement(react_toastify_1.ToastContainer, null)));
};
exports["default"] = ProfileManagement;
