...
var image_1 = require("next/image"); // For logo and edit images
    ...
    react_1.useEffect(function () {
        function fetchStudentData() {
            return __awaiter(this, void 0, void 0, function () {
                var token, profileResponse, profileData, userId, studentResponse, data, error_1;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    setLoading(true);
                    if (!studentId) {
                        react_toastify_1.toast.error("Student ID not found. Please try again later.", {
                            position: "top-center",
                            autoClose: 3000
                        });
                        setLoading(false);
    ...
    return (react_1["default"].createElement("div", { className: "min-h-screen flex flex-col lg:flex-row items-center justify-between bg-gray-900 text-gray-200 p-8 space-x-8" },
        react_1["default"].createElement("div", { className: "flex flex-col items-center lg:items-start lg:ml-16" },
            react_1["default"].createElement("h1", { className: "text-6xl font-extrabold text-white mb-4 flex items-center" },
                ...
                react_1["default"].createElement("span", { className: "text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500" }, "Profile")),
        ...
        react_1["default"].createElement("div", { className: "w-full lg:max-w-xl p-6 rounded-lg shadow-lg bg-gray-800" },
            ...
            react_1["default"].createElement("form", { onSubmit: handleSubmit, className: "space-y-6" },
                ...
                react_1["default"].createElement("div", { className: "flex justify-center" },
                    react_1["default"].createElement("button", { type: "submit", className: "w-full py-4 px-6 bg-gradient-to-r from-purple-500 to-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-gradient-to-r hover:from-purple-600 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200", disabled: loading }, loading ? "Updating..." : "Update Profile"))),
            react_1["default"].createElement("button", { onClick: function () { return router.push("/student/profile"); }, className: "mt-6 py-2 px-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg hover:from-blue-400 hover:to-purple-500 transition duration-300" }, "Back to Profile")),
