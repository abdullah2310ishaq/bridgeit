    ...
    const fetchMeetingDetails = async () => {
      ...
      try {
        ...
        const meetingResponse = await fetch(
          `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/fyp-meeting/by-id/${meetingId}`,
          {
        ...
        const fypResponse = await fetch(
          `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/fyp/get-detailed-fyp-by-id/${meetingDetails.fypId}`,
          {
            headers: { Authorization: `Bearer ${token}` },
          },
        )
        ...
        try {
          const expertResponse = await fetch(
            `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/get-industry-expert/industry-expert-by-id/${meetingDetails.indExpId}`,
            {
              headers: { Authorization: `Bearer ${token}` },
            },
          )
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/fyp-meeting/add-link/${meetingId}`,
        {
          method: "PATCH",
          headers: {
    ...
    <div className="min-h-screen bg-gray-900 text-gray-100">
      ...
      <header className="bg-gray-800 border-b border-gray-700 py-6 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-3xl font-bold text-purple-400">Add Meeting Link</h1>
          <p className="text-gray-400 mt-2">{meeting.fypTitle}</p>
        </div>
      </header>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-200">{meeting.fypTitle}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 p-3 bg-gray-700 border border-gray-600 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-purple-500"
                    value={meetingLink}
              ...
              <div className="bg-blue-900/20 p-4 rounded-lg border border-blue-800">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-200">Important</p>
