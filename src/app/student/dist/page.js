...
var StudentPage = function () {
    ...
    return (react_1["default"].createElement("div", { className: "min-h-screen bg-gray-900 text-gray-300 p-6" },
        ...
        react_1["default"].createElement("div", { className: "relative flex flex-col md:flex-row justify-between items-center bg-gray-800 bg-opacity-80 p-12 rounded-2xl shadow-2xl mb-8 overflow-hidden", style: { backgroundImage: "url('/studentbg.jpg')", height: "600px", backgroundSize: 'cover', backgroundPosition: 'center' } },
            react_1["default"].createElement("div", { className: "absolute inset-0 bg-black bg-opacity-30 backdrop-blur-sm" }),
            react_1["default"].createElement("div", { className: "relative flex items-center w-full z-10" },
                react_1["default"].createElement("div", { className: "text-white flex-grow pr-10" },
                    react_1["default"].createElement("h2", { className: "text-6xl font-bold text-green-400 leading-tight drop-shadow-2xl" },
                        "Welcome, ",
                    ...
                    react_1["default"].createElement("div", { className: "mt-6 space-x-4" },
                        react_1["default"].createElement("button", { onClick: goToEditProfile, className: "px-10 py-4 bg-blue-500 text-white font-bold rounded-full shadow-lg hover:shadow-blue-500/50 transition duration-300 transform hover:scale-105" }, "Edit Profile"),
                        react_1["default"].createElement("button", { onClick: gotoProfile, className: "px-10 py-4 bg-purple-500 text-white font-bold rounded-full shadow-lg hover:shadow-purple-500/50 transition duration-300 transform hover:scale-105" }, "View Profile"))),
                react_1["default"].createElement("div", { className: "relative z-10 mt-6 md:mt-0 md:w-1/2 flex justify-center" },
                    react_1["default"].createElement("img", { src: "data:image/jpeg;base64," + userProfile.imageData, alt: userProfile.firstName + " " + userProfile.lastName, className: "w-80 h-80 rounded-full border-4 border-green-400 object-cover shadow-2xl transform hover:scale-110 transition duration-300" })))),
        react_1["default"].createElement("section", { className: "relative py-16 bg-gray-900" },
            react_1["default"].createElement("div", { className: "absolute inset-y-0 right-0 w-1/2 bg-cover bg-center opacity-20", style: { backgroundImage: "url('/projectBG.png')", backgroundSize: "contain", backgroundRepeat: "no-repeat" } }),
            react_1["default"].createElement("div", { className: "relative max-w-7xl mx-auto flex justify-between items-center mb-16" },
        ...
        react_1["default"].createElement("section", { className: "py-16 bg-gray-900" },
            react_1["default"].createElement("div", { className: "w-full md:w-1/2 text-left mb-12" },
