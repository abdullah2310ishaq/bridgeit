  ...
  useEffect(() => {
    ...
    const fetchIdeaDetails = async () => {
      ...
      try {
        ...
        const ideaResponse = await fetch(`https://localhost:7053/api/ideas/get-idea-by-id/${id}`, {
          method: "GET",
          headers: {
        ...
        if (ideaData.length > 0) {
          ...
          const allIdeasResponse = await fetch(
            `https://localhost:7053/api/ideas/get-ideas-by-uni/${ideaData[0].uniName}`,
            {
              method: "GET",
              headers: {
                Authorization: `Bearer ${token}`,
        ...
        const interestResponse = await fetch(
          `https://localhost:7053/api/interested-for-idea/get-interested-students/${id}`,
          {
            method: "GET",
            headers: {
              Authorization: `Bearer ${token}`,
