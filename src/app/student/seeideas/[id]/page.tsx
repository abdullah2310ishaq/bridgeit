  ...
  useEffect(() => {
    ...
    const fetchIdeaDetails = async () => {
      ...
      try {
        ...
        const ideaResponse = await fetch(`http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/ideas/get-idea-by-id/${id}`, {
          method: "GET",
          headers: {
        ...
        if (ideaData.length > 0) {
          ...
          const allIdeasResponse = await fetch(
            `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/ideas/get-ideas-by-uni/${ideaData[0].uniName}`,
            {
              method: "GET",
              headers: {
                Authorization: `Bearer ${token}`,
        ...
        const studentResponse = await fetch(`http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/get-student/student-by-id/${userId}`, {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
          },
        ...
        const interestResponse = await fetch(
          `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/interested-for-idea/get-interested-students/${id}`,
          {
            method: "GET",
            headers: {
              Authorization: `Bearer ${token}`,
  ...
  const handleExpressInterest = async () => {
    ...
    try {
      const response = await fetch(
        `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/interested-for-idea/student-interested-for-idea/${userProfile.stdId}/${idea.id}`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
