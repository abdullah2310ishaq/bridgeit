  ...
  useEffect(() => {
    async function fetchData() {
      ...
      try {
        ...
        const studentRes = await fetch(`http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/get-student/student-by-id/${userId}`, {
          headers: { Authorization: `Bearer ${token}` },
        })
        if (!studentRes.ok) {
          router.push("/unauthorized")
        ...
        const proposalsRes = await fetch(
          `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/project-proposals/get-proposal-for-student/${studentData.id}`,
          {
            headers: { Authorization: `Bearer ${token}` },
          },
        )
        ...
        const projectsRes = await fetch("http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/projects/get-expert-projects", {
          headers: { Authorization: `Bearer ${token}` },
        })
        if (!projectsRes.ok) {
