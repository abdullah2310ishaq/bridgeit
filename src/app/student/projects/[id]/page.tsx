...
const ProjectPage = () => {
  ...
  useEffect(() => {
    async function fetchProject() {
      try {
        const res = await fetch(`http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/projects/${id}`);
