...
const ChatSignalR: React.FC<ChatSignalRProps> = ({ senderId, receiverId }) => {
  ...
  useEffect(() => {
    ...
    const newConnection = new signalR.HubConnectionBuilder()
      .withUrl("http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/chathub", {
    ...
    const fetchMessages = async () => {
      ...
      try {
        const response = await fetch(
          `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/chats/message-history/${senderId}/${receiverId}`,
          {
            headers: {
  ...
  const sendMessage = async () => {
    ...
    try {
      const response = await fetch("http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/chats/send-message", {
        method: "POST",
        headers: {
