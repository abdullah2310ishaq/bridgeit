...
const FypDetailPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchFypDetails = async () => {
      try {
        const response = await fetch(`http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/fyp/get-detailed-fyp-by-id/${fypId}`, {
          method: "GET",
          headers: {
    ...
    const fetchFacultyDetails = async (facultyId: string, token: string) => {
      try {
        const response = await fetch(`http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/get-faculty/faculty-by-faculity-id/${facultyId}`, {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleApprove = async () => {
    ...
    try {
      const response = await fetch(`http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/uni-admin-for-fyp/approve-fyp?fypId=${fypId}`, {
        method: "PUT",
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const handleReject = async () => {
    ...
    try {
      const response = await fetch(`http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/uni-admin-for-fyp/reject-fyp?fypId=${fypId}`, {
        method: "PUT",
        headers: {
          Authorization: `Bearer ${token}`,
        },
