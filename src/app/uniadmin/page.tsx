    ...
    const fetchAdminData = async () => {
      try {
        ...
        const adminResponse = await fetch(
          `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/get-uni-admins/admins-by-id/${profileData.userId}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
              "Content-Type": "application/json",
        ...
        const [studentsRes, facultyRes] = await Promise.all([
          fetch(`http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/get-student/student-by-university/${adminData.university}`, {
            headers: {
              Authorization: `Bearer ${token}`,
              "Content-Type": "application/json",
            },
          }),
          fetch(`http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/get-faculty/faculty-by-university/${adminData.university}`, {
            headers: {
              Authorization: `Bearer ${token}`,
              "Content-Type": "application/json",
            },
  ...
  const handleSearch = async (query: string, searchType: string) => {
    ...
    try {
      ...
      if (searchType === "student") {
        ...
        if (!isNumeric) {
          // Search by name
          url = `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/get-student/student-by-name/${encodeURIComponent(query)}`
        } else {
          // Search by ID
          url = `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/get-student/student-by-student-id/${encodeURIComponent(query)}`
        }
        ...
        if (!isNumeric) {
          // Search by name
          url = `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/get-faculty/faculty-by-name/${encodeURIComponent(query)}`
        } else {
          // Search by ID
          url = `http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/get-faculty/faculty-by-faculty-id/${encodeURIComponent(query)}`
        }
