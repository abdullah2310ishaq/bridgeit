...
const EditUniAdminProfile: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchProfile = async () => {
      try {
        const response = await fetch('http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/auth/authorized-user-info', {
          method: 'GET',
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await fetch(`http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/edit-user-profile/update-user-description/${profile.userId}`, {
        method: 'PUT',
        headers: {
      ...
      if (form.profileImage) {
        ...
        await fetch(`http://api-bridgeit-htb0fpcee0ajb7a2.westindia-01.azurewebsites.net/api/edit-user-profile/set-profile-image/${profile.userId}`, {
          method: 'PUT',
          headers: {
            Authorization: `Bearer ${token}`,
            'Content-Type': 'application/json',
